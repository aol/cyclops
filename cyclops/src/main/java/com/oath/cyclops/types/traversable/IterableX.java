...
public interface IterableX<T> extends Traversable<T>,
  ...
  @Override
     ...
     */
    default IterableX<T> xPer(final int x, final long time, final TimeUnit t) {
     ...
     */
    default IterableX<T> onePer(final long time, final TimeUnit t) {
     ...
     */
    default IterableX<T> fixedDelay(final long l, final TimeUnit unit) {
