...
public interface LazyEither5<LT1, LT2,LT3, LT4,RT> extends Transformable<RT>,
    ...
    static <LT2,LT3,LT4,RT> LazyEither5.CompletableEither5<RT,LT2,LT3,LT4,RT> either5(){
        ...
        return new CompletableEither5<RT,LT2,LT3,LT4, RT>(c,fromFuture(Future.of(c)));
    }
    ...
    default <R> R fold(Function<? super LT1, ? extends R> fn1, Function<? super LT2, ? extends R> fn2, Function<? super LT3, ? extends R> fn3, Function<? super LT4, ? extends R> fn4, Function<? super RT, ? extends R> fn5){
        return this.fold(fn1,fn2,fn3,fn4,fn5);
    }
    ...
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X, R> R foldAny(
        LazyEither5<LT1, LT2, LT3, LT4, RT> either, Function<? super X, ? extends R> fn) {
        return either.fold(fn, fn, fn, fn, fn);
    }
  ...
  public static <L1,L2,L3,L4,T,R> LazyEither5<L1, L2, L3, L4, ReactiveSeq<R>> traverse(Function<? super T,? extends R> fn,ReactiveSeq<LazyEither5<L1, L2, L3,L4,T>> stream) {
    ...
    final static class Lazy<ST, M,M2,M3, PT> implements LazyEither5<ST, M,M2,M3, PT> {
        ...
        public <R1, R2> LazyEither5<ST, M,M2,R1, R2> bimap(final Function<? super M3, ? extends R1> fn1,
            ...
            return LazyEither5.fromLazy(lazy.map(m->m.bimap(fn1,fn2)));
        }
        ...
        @Override
        public int hashCode() {
            return this.fold(LazyEither5::left1, LazyEither5::left2, LazyEither5::left3, LazyEither5::left4, LazyEither5::right).hashCode();
        }
        ...
        public boolean equals(Object obj) {
            return this.fold(LazyEither5::left1, LazyEither5::left2, LazyEither5::left3, LazyEither5::left4, LazyEither5::right).equals(obj);
        }
