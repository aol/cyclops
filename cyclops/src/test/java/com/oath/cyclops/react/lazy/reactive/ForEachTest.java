package com.oath.cyclops.react.lazy.reactive;
...
public class ForEachTest {
	...
	public void forEachX(){
		...
		Subscription s = DuplicationTest.of(1,2,3).forEach( 2, System.out::println);
	...
	public void forEachXTest(){
		...
		Subscription s = DuplicationTest.of(1,2,3).forEach( 2, i->list.add(i));
	...
	public void forEachXWithErrors(){
		...
		FutureStream<Integer> stream = DuplicationTest.of(()->1,()->2,()->3,(Supplier<Integer>)()->{ throw new RuntimeException();},()->4).map(Supplier::get);
	...
	public void forEachXWithEvents(){
		...
		FutureStream<Integer> stream =  DuplicationTest.of(()->1,()->2,()->3,(Supplier<Integer>)()->{ throw new RuntimeException();}).map(Supplier::get);
		Subscription s = stream.forEach( 2, i->list.add(i),
	...
	public void forEachWithErrorsAsync(){
		...
		List<Integer> list = new ArrayList<>();
		assertThat(error,nullValue());
		FutureStream<Integer> stream = DuplicationTest.of(()->1,()->2,()->3,(Supplier<Integer>)()->{ throw new RuntimeException();},()->4,()->5)
													.async()
													.map(Supplier::get);
		stream.forEach(i->list.add(i),
								e->error=e);
