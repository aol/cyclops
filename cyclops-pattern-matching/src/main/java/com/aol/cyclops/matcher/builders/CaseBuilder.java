...
public class CaseBuilder {
	...
	public static class InCaseOfBuilderExtractor<T,R,X>{
		...
		@AllArgsConstructor
		public class InCaseOfStep<V> implements CollectionStep<V,X>{
			private final Predicate<V> match;
		...
		@AllArgsConstructor
		public class InMatchOf<V>implements CollectionStep<V,X>{
		...
		@AllArgsConstructor
		public class InCaseOfValueStep<V,X> implements CollectionStep<V,X>{
			private V value;
			/* 
			 * @see com.aol.cyclops.matcher.builders.Step#thenApply(com.aol.cyclops.matcher.PatternMatcher.ActionWithReturn)
			 */
	...
	public static class InMatchOfBuilder<V,X>{
		...
		@AllArgsConstructor
		public class InMatchOfThenExtract<V,X,R> implements CollectionStep<V,X>{
