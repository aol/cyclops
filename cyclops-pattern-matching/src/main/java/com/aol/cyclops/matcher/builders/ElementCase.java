...
public class ElementCase<X> extends CaseBeingBuilt{
	 ...
	 * 
	 * @param match Predicate which will trigger this case
	 ...
	 * 
	 * @param match Hamcrest Matcher that will trigger this case
	 * @return Next Step in the Case Builder process
	 */
	 ...
	 * 
	 * @param extractor Extractor to preprocess input data
	 * @return Next step in the Case Builder process
	 */
