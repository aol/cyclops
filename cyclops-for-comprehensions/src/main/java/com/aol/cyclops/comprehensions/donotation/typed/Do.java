...
public class Do {
	...
	public static class DoComp0 extends DoComp{
		...
		public <T1> DoComp1<T1> add(Streamable<T1> o){	
			return new DoComp1(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
			
		}
		public  DoComp1<String> add(File o){	
			return new DoComp1(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
			
		}
		public  DoComp1<String> add(BufferedReader o){	
			return new DoComp1(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
	...
	public static class DoComp1<T1> extends DoComp{
		 ...
		 */
		public <R> R yield(Function<T1,?> f){
		...
		public <T2> DoComp2<T1,T2> andIterable(Function<T1,Iterable<T2>> f){
			return  new DoComp2<T1,T2>(addToAssigned(f));
		}
		public <T2> DoComp2<T1,T2> with(Collection<T2> o){	
			return new DoComp2<T1,T2>(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
		}
		public <T2> DoComp2<T1,T2> and(Function<T1,AnyM<T2>> f){
			return  new DoComp2<T1,T2>(addToAssigned(f));
		}
		public <T2> DoComp2<T1,T2> with(AnyM<T2> o){	
			return new DoComp2<T1,T2>(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
		}
	...
	public static class DoComp2<T1,T2> extends DoComp{
