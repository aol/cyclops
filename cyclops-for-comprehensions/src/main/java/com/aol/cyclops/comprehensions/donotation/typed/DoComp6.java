...
import com.aol.cyclops.lambda.monads.TraversableM;
	public class DoComp6<T1,T2,T3,T4,T5,T6> extends DoComp{
		 ...
		 * @return Next stage in for comprehension builder
		 */
		public <T7> DoComp7<T1,T2,T3,T4,T5,T6,T7> add(Stream<T7> o){
			return new DoComp7(assigned.plus(assigned.size(),new Entry("$$monad"+assigned.size(),o)));
		 ...
		 */
		public <R> R yield(Function<T1,Function<T2,Function<T3,Function<T4,Function<T5,Function<T6,?>>>>>> f){
		 ...
		 */
		public  DoComp6 filter(Function<T1,Function<T2,Function<T3,Function<T4,Function<T5,Function<T6,Boolean>>>>>> f){
