...
public interface AnyMForComprehensionHandler<U> {
	...
	<R1, R2, R> AnyM<R> forEach3(AnyM<U> anyM, Function<U, ? extends AnyM<R1>> monad1, BiFunction<U, R1, ? extends AnyM<R2>> monad2,
			Function<U, Function<R1, Function<R2, Boolean>>> filterFunction, Function<U, Function<R1, Function<R2, R>>> yieldingFunction);
