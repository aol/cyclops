...
import com.aol.cyclops.react.reactivestreams.FutureStreamAsyncPublisher;
import com.aol.cyclops.react.reactivestreams.FutureStreamSynchronousPublisher;
import com.aol.cyclops.react.stream.CloseableIterator;
...
public interface LazyFutureStream<U> extends  LazySimpleReactStream<U>,LazyStream<U>,
    ...
    default LazyFutureStream<U> scanRight(Monoid<U> monoid) {
        return fromStream(ReactiveSeq.fromStream(toQueue().stream(getSubscription())).scanRight(monoid));
     ...
     * @see com.aol.cyclops.react.stream.ThreadPools#setUseCommon(boolean)
     *
     */
