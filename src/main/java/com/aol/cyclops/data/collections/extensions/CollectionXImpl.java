...
@AllArgsConstructor
public class CollectionXImpl<T> extends AbstractFluentCollectionX<T> implements FluentCollectionX<T> {
 ...
 //   @Override
     ...
     */
  //  @Override
    public <X> FluentCollectionX<X> fromStream(Stream<X> stream) {
