...
public interface PersistentCollectionX<T> extends FluentCollectionX<T> {
    ...
    */
    ...
    default <K, A, D> PersistentCollectionX<Tuple2<K, D>> grouped(Function<? super T, ? extends K> classifier,
     ...
     */
    @Override
    default <R> PersistentCollectionX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1, Supplier<? extends R> otherwise) {
    ...
    @Override
    default <C extends Collection<? super T>> PersistentCollectionX<C> groupedWhile(Predicate<? super T> predicate, Supplier<C> factory) {
    ...
    @Override
    default <C extends Collection<? super T>> PersistentCollectionX<C> groupedUntil(Predicate<? super T> predicate, Supplier<C> factory) {
