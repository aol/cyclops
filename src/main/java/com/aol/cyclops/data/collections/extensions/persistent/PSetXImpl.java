...
public class PSetXImpl<T> implements PSetX<T> {
     ...
     */
    @Override
    public PSetX<T> minus(final Object e) {
        return new PSetXImpl<>(
                               set.minus(e));
    }
     ...
     */
    @Override
    public PSetX<T> plusAll(final Collection<? extends T> list) {
        return new PSetXImpl<>(
                               set.plusAll(list));
    }
     ...
     */
    @Override
    public PSetX<T> minusAll(final Collection<?> list) {
        return new PSetXImpl<>(
                               set.minusAll(list));
    }
