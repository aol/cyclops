...
public interface PBagX<T> extends PBag<T>, PersistentCollectionX<T>, OnEmptySwitch<T,PBag<T>>{
    ...
    public static PBagX<Integer> range(int start, int end) {
        return ReactiveSeq.range(start,end).toPBagX();
    }
    /**
    ...
    public static PBagX<Long> rangeLong(long start, long end) {
        return ReactiveSeq.rangeLong(start,end).toPBagX();
    }
    /**
    ...
    static <U,T> PBagX<T> unfold(U seed,Function<? super U,Optional<Tuple2<T,U>>> unfolder){
        return ReactiveSeq.unfold(seed, unfolder).toPBagX();
    }
    /**
    ...
    public static <T> PBagX<T> generate(long limit,Supplier<T> s){
        ...
        return ReactiveSeq.generate(s).limit(limit).toPBagX();
     }
    /**
    ...
    public static <T> PBagX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
        return ReactiveSeq.iterate(seed, f).limit(limit).toPBagX();
