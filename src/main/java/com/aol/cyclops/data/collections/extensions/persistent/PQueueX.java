...
public interface PQueueX<T> extends PQueue<T>, PersistentCollectionX<T>, OnEmptySwitch<T, PQueue<T>> {
     ...
     */
    public static PQueueX<Integer> range(int start, int end) {
     ...
     * @return Range PQueueX
     */
    public static PQueueX<Long> rangeLong(long start, long end) {
     ...
     */
    static <U, T> PQueueX<T> unfold(U seed, Function<? super U, Optional<Tuple2<T, U>>> unfolder) {
     ...
     */
    public static <T> PQueueX<T> generate(long limit, Supplier<T> s) {
     ...
     */
    public static <T> PQueueX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
     ...
     */
    @Override
    default <R> PQueueX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1, Supplier<? extends R> otherwise) {
    ...
    @Override
    default <C extends Collection<? super T>> PQueueX<C> groupedWhile(Predicate<? super T> predicate, Supplier<C> factory) {

        return (PQueueX<C>) PersistentCollectionX.super.groupedWhile(predicate, factory);
    }

    @Override
    default <C extends Collection<? super T>> PQueueX<C> groupedUntil(Predicate<? super T> predicate, Supplier<C> factory) {
