...
public interface PVectorX<T> extends PVector<T>, PersistentCollectionX<T>, OnEmptySwitch<T, PVector<T>> {
    ...
    */
     ...
     */
    @Override
    default <U, R> PVectorX<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (PVectorX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> PVectorX<R> zip(Seq<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (PVectorX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> PVectorX<R> zip(Stream<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
     ...
     */
    @Override
    default <T2, T3, T4> PVectorX<Tuple4<T, T2, T3, T4>> zip4(Stream<? extends T2> second, Stream<? extends T3> third, Stream<? extends T4> fourth) {
     ...
     */
    @Override
    default PVectorX<T> onEmptySwitch(Supplier<? extends PVector<T>> supplier) {
        if (this.isEmpty())
     ...
     */
    @Override
    default <R> PVectorX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1, Supplier<? extends R> otherwise) {
    ...
    @Override
    default <C extends Collection<? super T>> PVectorX<C> groupedWhile(Predicate<? super T> predicate, Supplier<C> factory) {

        return (PVectorX<C>) PersistentCollectionX.super.groupedWhile(predicate, factory);
    }

    @Override
    default <C extends Collection<? super T>> PVectorX<C> groupedUntil(Predicate<? super T> predicate, Supplier<C> factory) {
