...
public interface PStackX<T> extends PStack<T>, PersistentCollectionX<T>, FluentSequenceX<T>, OnEmptySwitch<T, PStack<T>> {
     ...
     */
    static <U, T> PStackX<T> unfold(U seed, Function<? super U, Optional<Tuple2<T, U>>> unfolder) {
     ...
     */
    public static <T> PStackX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
    ...
    */
     ...
     */
    @Override
    default <U, R> PStackX<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (PStackX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> PStackX<R> zip(Seq<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (PStackX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> PStackX<R> zip(Stream<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
     ...
     */
    @Override
    default <T2, T3, T4> PStackX<Tuple4<T, T2, T3, T4>> zip4(Stream<? extends T2> second, Stream<? extends T3> third, Stream<? extends T4> fourth) {
     ...
     */
    @Override
    default <R> PStackX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1, Supplier<? extends R> otherwise) {
    ...
    @Override
    default <C extends Collection<? super T>> PStackX<C> groupedWhile(Predicate<? super T> predicate, Supplier<C> factory) {

        return (PStackX<C>) PersistentCollectionX.super.groupedWhile(predicate, factory);
    }

    @Override
    default <C extends Collection<? super T>> PStackX<C> groupedUntil(Predicate<? super T> predicate, Supplier<C> factory) {
