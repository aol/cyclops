...
public interface SortedSetX<T> extends SortedSet<T>,MutableCollectionX<T> {
    ...
    public static SortedSetX<Integer> range(int start, int end) {
        return ReactiveSeq.range(start,end).toSortedSetX();
    }
    /**
    ...
    public static SortedSetX<Long> rangeLong(long start, long end) {
        return ReactiveSeq.rangeLong(start,end).toSortedSetX();
    }
    /**
    ...
    static <U,T> SortedSetX<T> unfold(U seed,Function<? super U,Optional<Tuple2<T,U>>> unfolder){
        return ReactiveSeq.unfold(seed, unfolder).toSortedSetX();
    }
    /**
    ...
    public static <T> SortedSetX<T> generate(long limit,Supplier<T> s){
        ...
        return ReactiveSeq.generate(s).limit(limit).toSortedSetX();
     }
    /**
    ...
    public static <T> SortedSetX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
        return ReactiveSeq.iterate(seed, f).limit(limit).toSortedSetX();
