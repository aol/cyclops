...
public interface POrderedSetX<T> extends POrderedSet<T>, PersistentCollectionX<T>, OnEmptySwitch<T, POrderedSet<T>> {
     ...
     */
    static <U, T> POrderedSetX<T> unfold(U seed, Function<? super U, Optional<Tuple2<T, U>>> unfolder) {
     ...
     */
    public static <T> POrderedSetX<T> iterate(long limit, final T seed, final UnaryOperator<T> f) {
    ...
    */
     ...
     */
    @Override
    default <U, R> POrderedSetX<R> zip(Iterable<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (POrderedSetX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> POrderedSetX<R> zip(Seq<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (POrderedSetX<R>) PersistentCollectionX.super.zip(other, zipper);
    }

    @Override
    default <U, R> POrderedSetX<R> zip(Stream<? extends U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
    ...
    */
     ...
     */
    @Override
    default <R> POrderedSetX<R> patternMatch(Function<CheckValue1<T, R>, CheckValue1<T, R>> case1, Supplier<? extends R> otherwise) {
    ...
    @Override
    default <C extends Collection<? super T>> POrderedSetX<C> groupedWhile(Predicate<? super T> predicate, Supplier<C> factory) {

        return (POrderedSetX<C>) PersistentCollectionX.super.groupedWhile(predicate, factory);
    }

    @Override
    default <C extends Collection<? super T>> POrderedSetX<C> groupedUntil(Predicate<? super T> predicate, Supplier<C> factory) {
