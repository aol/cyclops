...
public class DoComp4<T1, T2, T3, T4> extends DoComp {
    ...
    public <T5> DoComp5<T1, T2, T3, T4, T5> reader(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, Reader<?, ? extends T5>>>>> f) {
        return new DoComp5<>(
    ...
    public <T5> DoComp5<T1, T2, T3, T4, T5> iterable(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, Iterable<T5>>>>> f) {
        return new DoComp5<>(
                             addToAssigned(f), getOrgType());
    }

    public <T5> DoComp5<T1, T2, T3, T4, T5> publisher(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, Publisher<T5>>>>> f) {
        return new DoComp5<>(
                             addToAssigned(f), getOrgType());
    }

    public <T5> DoComp5<T1, T2, T3, T4, T5> stream(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, BaseStream<T5, ?>>>>> f) {
        return new DoComp5<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T5> DoComp5<T1, T2, T3, T4, T5> optional(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, Optional<T5>>>>> f) {
        return new DoComp5<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T5> DoComp5<T1, T2, T3, T4, T5> future(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, CompletableFuture<T5>>>>> f) {
        return new DoComp5<>(
                             addToAssigned(f), getOrgType());
