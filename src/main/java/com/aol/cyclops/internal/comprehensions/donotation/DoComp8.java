...
public class DoComp8<T,T1,T2,T3,T4,T5,T6,T7> extends DoComp{
	...
	public <R> AnyMSeq<R> yield(Function<? super T,Function<? super T1,Function<? super T2,Function<? super T3,Function<? super T4,Function<? super T5,Function<? super T6,Function<? super T7,? extends R>>>>>>>>  f){
		if(getOrgType()!=null)
			return new MonadWrapper<>(this.yieldInternal(f),this.getOrgType()).anyMSeq();
		else
			return AnyM.ofSeq(this.yieldInternal(f));
	}
	public <R> AnyMSeq<R> yield(OctFunction<? super T,? super T1,? super T2,? super T3,? super T4,? super T5,? super T6,? super T7,? extends R>  f){
