...
public class DoComp6<T1, T2, T3, T4, T5, T6> extends DoComp {
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> reader(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, Reader<?, ? extends T7>>>>>>> f) {
        return new DoComp7<>(
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> iterable(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, Iterable<T7>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> publisher(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, Publisher<T7>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> stream(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, BaseStream<T7, ?>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> optional(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, Optional<T7>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> future(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, CompletableFuture<T7>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <T7> DoComp7<T1, T2, T3, T4, T5, T6, T7> anyM(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, AnyM<T7>>>>>>> f) {
        return new DoComp7<>(
                             addToAssigned(f), getOrgType());
    ...
    public <R> AnyMSeq<R> yield(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<? super T4, Function<? super T5, Function<? super T6, ? extends R>>>>>> f) {
        if (getOrgType() != null)
    ...
    public DoComp6<T1, T2, T3, T4, T5, T6> filter(
            Function<? super T1, Function<? super T2, Function<? super T3, Function<T4, Function<? super T5, Function<? super T6, Boolean>>>>>> f) {
        return new DoComp6<>(
