...
public class CurryConsumer extends Lambda {
    ...
    public static <T1, T2, T3> Function<T1, Function<T2, Consumer<T3>>> curryC3(final TriConsumer<T1, T2, T3> triCon) {
        return t1 -> t2 -> t3 -> triCon.accept(t1, t2, t3);
    }

    public static <T1, T2, T3, T4> Function<T1, Function<T2, Function<T3, Consumer<T4>>>> curryC4(final QuadConsumer<T1, T2, T3, T4> quadCon) {
    ...
    public static <T1, T2, T3, T4, T5> Function<T1, Function<T2, Function<T3, Function<T4, Consumer<T5>>>>> curryC5(
            final QuintConsumer<T1, T2, T3, T4, T5> quintCon) {
