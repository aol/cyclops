...
public class Uncurry extends UncurryConsumer {
    ...
    public static <T1, T2, T3, R> TriFunction<T1, T2, T3, R> uncurry3(final Function<T1, Function<T2, Function<T3, R>>> triFunc) {
        return (t1, t2, t3) -> triFunc.apply(t1)
                                      .apply(t2)
                                      .apply(t3);
    }

    public static <T1, T2, T3, T4, R> QuadFunction<T1, T2, T3, T4, R> uncurry4(
    ...
    public static <T1, T2, T3, T4, T5, R> QuintFunction<T1, T2, T3, T4, T5, R> uncurry5(
    ...
    public static <T1, T2, T3, T4, T5, T6, R> HexFunction<T1, T2, T3, T4, T5, T6, R> uncurry6(
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> HeptFunction<T1, T2, T3, T4, T5, T6, T7, R> uncurry7(
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> uncurry8(
