    ...
    * }
    ...
    public boolean isSeqPresent() {
     ...
     public MaybeTSeq<T> combine(BiPredicate<? super T, ? super T> predicate, BinaryOperator<T> op) {
         ...
         return (MaybeTSeq<T>)Traversable.super.combine(predicate, op);
     }
     ...
     public MaybeTSeq<T> cycle(int times) {
         ...
         return (MaybeTSeq<T>)Traversable.super.cycle(times);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> cycle(Monoid<T> m, int times) {
         ...
         return (MaybeTSeq<T>)Traversable.super.cycle(m, times);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> cycleWhile(Predicate<? super T> predicate) {
         ...
         return (MaybeTSeq<T>)Traversable.super.cycleWhile(predicate);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> cycleUntil(Predicate<? super T> predicate) {
         ...
         return (MaybeTSeq<T>)Traversable.super.cycleUntil(predicate);
     }
     /* (non-Javadoc)
     ...
     public <U, R> MaybeTSeq<R> zip(Iterable<U> other, BiFunction<? super T, ? super U, ? extends R> zipper) {
         ...
         return (MaybeTSeq<R>)Traversable.super.zip(other, zipper);
     }
     /* (non-Javadoc)
     ...
     public <U> MaybeTSeq<Tuple2<T, U>> zipStream(Stream<U> other) {
         ...
         return (MaybeTSeq<Tuple2<T, U>>)Traversable.super.zipStream(other);
     }
     /* (non-Javadoc)
     ...
     public <U> MaybeTSeq<Tuple2<T, U>> zip(Seq<U> other) {
         ...
         return (MaybeTSeq<Tuple2<T, U>>)Traversable.super.zip(other);
     }
     /* (non-Javadoc)
     ...
     public <S, U> MaybeTSeq<Tuple3<T, S, U>> zip3(Stream<? extends S> second, Stream<? extends U> third) {
         ...
         return (MaybeTSeq)Traversable.super.zip3(second, third);
     }
     /* (non-Javadoc)
     ...
     public <T2, T3, T4> MaybeTSeq<Tuple4<T, T2, T3, T4>> zip4(Stream<T2> second, Stream<T3> third,
         ...
         return (MaybeTSeq<Tuple4<T, T2, T3, T4>>)Traversable.super.zip4(second, third, fourth);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<Tuple2<T, Long>> zipWithIndex() {
         ...
         return (MaybeTSeq<Tuple2<T, Long>>)Traversable.super.zipWithIndex();
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> sliding(int windowSize) {
         ...
         return (MaybeTSeq<ListX<T>>)Traversable.super.sliding(windowSize);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> sliding(int windowSize, int increment) {
         ...
         return (MaybeTSeq<ListX<T>>)Traversable.super.sliding(windowSize, increment);
     }
     /* (non-Javadoc)
     ...
     public <C extends Collection<? super T>> MaybeTSeq<C> grouped(int size, Supplier<C> supplier) {
         ...
         return (MaybeTSeq<C> )Traversable.super.grouped(size, supplier);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> groupedUntil(Predicate<? super T> predicate) {
         ...
         return (MaybeTSeq<ListX<T>>)Traversable.super.groupedUntil(predicate);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> groupedStatefullyWhile(BiPredicate<ListX<? super T>, ? super T> predicate) {
         ...
         return (MaybeTSeq<ListX<T>>)Traversable.super.groupedStatefullyWhile(predicate);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> groupedWhile(Predicate<? super T> predicate) {
         ...
         return (MaybeTSeq<ListX<T>>)Traversable.super.groupedWhile(predicate);
     }
     /* (non-Javadoc)
     ...
     public <C extends Collection<? super T>> MaybeTSeq<C> groupedWhile(Predicate<? super T> predicate,
         ...
         return (MaybeTSeq<C>)Traversable.super.groupedWhile(predicate, factory);
     }
     /* (non-Javadoc)
     ...
     public <C extends Collection<? super T>> MaybeTSeq<C> groupedUntil(Predicate<? super T> predicate,
         ...
         return (MaybeTSeq<C>)Traversable.super.groupedUntil(predicate, factory);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<ListX<T>> grouped(int groupSize) {
         ...
         return ( MaybeTSeq<ListX<T>>)Traversable.super.grouped(groupSize);
     }
     /* (non-Javadoc)
     ...
     public <K, A, D> MaybeTSeq<Tuple2<K, D>> grouped(Function<? super T, ? extends K> classifier,
         ...
         return (MaybeTSeq)Traversable.super.grouped(classifier, downstream);
     }
     /* (non-Javadoc)
     ...
     public <K> MaybeTSeq<Tuple2<K, Seq<T>>> grouped(Function<? super T, ? extends K> classifier) {
         ...
         return (MaybeTSeq)Traversable.super.grouped(classifier);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> distinct() {
         ...
         return (MaybeTSeq<T>)Traversable.super.distinct();
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> scanLeft(Monoid<T> monoid) {
         ...
         return (MaybeTSeq<T>)Traversable.super.scanLeft(monoid);
     }
     /* (non-Javadoc)
     ...
     public <U> MaybeTSeq<U> scanLeft(U seed, BiFunction<U, ? super T, U> function) {
         ...
         return (MaybeTSeq<U>)Traversable.super.scanLeft(seed, function);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> scanRight(Monoid<T> monoid) {
         ...
         return (MaybeTSeq<T>)Traversable.super.scanRight(monoid);
     }
     /* (non-Javadoc)
     ...
     public <U> MaybeTSeq<U> scanRight(U identity, BiFunction<? super T, U, U> combiner) {
         ...
         return (MaybeTSeq<U>)Traversable.super.scanRight(identity, combiner);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> sorted() {
         ...
         return (MaybeTSeq<T>)Traversable.super.sorted();
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> sorted(Comparator<? super T> c) {
         ...
         return (MaybeTSeq<T>)Traversable.super.sorted(c);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> takeWhile(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.takeWhile(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> dropWhile(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.dropWhile(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> takeUntil(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.takeUntil(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> dropUntil(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.dropUntil(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> dropRight(int num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.dropRight(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> takeRight(int num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.takeRight(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> skip(long num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.skip(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> skipWhile(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.skipWhile(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> skipUntil(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.skipUntil(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> limit(long num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.limit(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> limitWhile(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.limitWhile(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> limitUntil(Predicate<? super T> p) {
         ...
         return (MaybeTSeq<T>)Traversable.super.limitUntil(p);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> intersperse(T value) {
         ...
         return (MaybeTSeq<T>)Traversable.super.intersperse(value);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> reverse() {
         ...
         return (MaybeTSeq<T>)Traversable.super.reverse();
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> shuffle() {
         ...
         return (MaybeTSeq<T>)Traversable.super.shuffle();
     }
     ...
     public MaybeTSeq<T> skipLast(int num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.skipLast(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> limitLast(int num) {
         ...
         return (MaybeTSeq<T>)Traversable.super.limitLast(num);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> onEmpty(T value) {
         ...
         return (MaybeTSeq<T>)Traversable.super.onEmpty(value);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> onEmptyGet(Supplier<T> supplier) {
         ...
         return (MaybeTSeq<T>)Traversable.super.onEmptyGet(supplier);
     }
     /* (non-Javadoc)
     ...
     public <X extends Throwable> MaybeTSeq<T> onEmptyThrow(Supplier<X> supplier) {
         ...
         return (MaybeTSeq<T>)Traversable.super.onEmptyThrow(supplier);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> shuffle(Random random) {
         ...
         return (MaybeTSeq<T>)Traversable.super.shuffle(random);
     }
     /* (non-Javadoc)
     ...
     public MaybeTSeq<T> slice(long from, long to) {
         ...
         return (MaybeTSeq<T>)Traversable.super.slice(from, to);
     }
     /* (non-Javadoc)
     ...
     public <U extends Comparable<? super U>> MaybeTSeq<T> sorted(Function<? super T, ? extends U> function) {
         return (MaybeTSeq)Traversable.super.sorted(function);
     }
}
