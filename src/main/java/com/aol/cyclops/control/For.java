...
public class For {
    ...
    public interface Values {
        ...
        static <T1,T2,T3,R1,R2, R3, R> AnyMValue< R> each4(MonadicValue<? extends T1> monadicValue,
                                            Function<? super T1, ? extends MonadicValue<R1>> value2, 
                                            BiFunction<? super T1, ? super R1,? extends MonadicValue<R2>> value3, 
         ...
         */
        static <T,R1, R> AnyMValue< R> each2(MonadicValue<? extends T> monadicValue,
                                            Function<? super T, ? extends MonadicValue<R1>> value2, 
                                            BiFunction<? super T,? super R1, Boolean> filterFunction,
                                            BiFunction<? super T,? super R1, ? extends R> yieldingFunction){
