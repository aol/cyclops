...
public interface Eval<T>
    ...
    default <T2, R1, R2, R3, R> Eval<R> forEach4(Function<? super T, ? extends MonadicValue<R1>> value1,
        ...
        return (Eval<R>)MonadicValue1.super.forEach4(value1, value2, value3, yieldingFunction);
    }
    ...
    default <T2, R1, R2, R3, R> Eval<R> forEach4(Function<? super T, ? extends MonadicValue<R1>> value1,
        ...
        return (Eval<R>)MonadicValue1.super.forEach4(value1, value2, value3, filterFunction, yieldingFunction);
    }
    ...
    default <T2, R1, R2, R> Eval<R> forEach3(Function<? super T, ? extends MonadicValue<R1>> value1,
        ...
        return (Eval<R>)MonadicValue1.super.forEach3(value1, value2, yieldingFunction);
    }
    ...
    default <T2, R1, R2, R> Eval<R> forEach3(Function<? super T, ? extends MonadicValue<R1>> value1,
        ...
        return (Eval<R>)MonadicValue1.super.forEach3(value1, value2, filterFunction, yieldingFunction);
    }
    ...
    default <R1, R> Eval<R> forEach2(Function<? super T, ? extends MonadicValue<R1>> value1,
        ...
        return (Eval<R>)MonadicValue1.super.forEach2(value1, yieldingFunction);
    }
    ...
    default <R1, R> Eval<R> forEach2(Function<? super T, ? extends MonadicValue<R1>> value1,
            ...
            BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (Eval<R>)MonadicValue1.super.forEach2(value1, filterFunction, yieldingFunction);
    }
