...
public interface Ior<ST, PT> extends Supplier<PT>, MonadicValue2<ST, PT>, BiFunctor<ST, PT>, Functor<PT>, Filterable<PT>, ApplicativeFunctor<PT> {
    ...
    @Override
    default <R> Xor<ST, R> patternMatch(Function<CheckValue1<PT, R>, CheckValue1<PT, R>> case1, Supplier<? extends R> otherwise) {
    ...
    default <R> R visit(Function<? super ST, ? extends R> secondary, Function<? super PT, ? extends R> primary,
            BiFunction<? super ST, ? super PT, ? extends R> both) {
    ...
    default <R1, R2> Ior<R1, R2> mapBoth(Function<? super ST, ? extends R1> secondary, Function<? super PT, ? extends R2> primary) {
        if (isSecondary())
