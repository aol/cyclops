...
@FunctionalInterface
public interface ZippingApplicative4<T, T2, T3, T4, R, D extends IterableFunctor<R>>
        extends Functor<Function<? super T, Function<? super T2, Function<? super T3, Function<? super T4, ? extends R>>>>> {
    ...
    default ZippingApplicative3<T2, T3, T4, R, D> ap(final Iterable<? extends T> f) {

        final Iterator<Function<? super T, Function<? super T2, Function<? super T3, Function<? super T4, ? extends R>>>>> fn = delegate().iterator();
