...
@FunctionalInterface
public interface ZippingApplicative3<T,T2,T3,R, D extends IterableFunctor<R>> extends 
					Functor<Function<? super T,Function<? super T2,Function<? super T3,? extends R>>>> {
	...
	default ZippingApplicative2<T2,T3,R,D> ap(Iterable<? extends T> f){
	
		Iterator<Function<? super T,Function<? super T2,Function<? super T3,? extends R>>>> fn = delegate().iterator();
