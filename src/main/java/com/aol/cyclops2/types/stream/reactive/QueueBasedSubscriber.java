...
/**
                    System.out.println("GET Being called queue size " + size() + " q " + this + " added " + counter.added
                                            + " open? " + this.isOpen() + " t "
                                            + Thread.currentThread().getId());**/
                    T res = super.get();
                //    System.out.println("Next in QS is " + res + " thread " + Thread.currentThread().getId() + " queue size " + size() + " q " + this);
                    return res;
