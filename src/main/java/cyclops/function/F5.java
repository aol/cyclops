...
public interface F5<T1, T2, T3, T4, T5, R> extends Function5<T1, T2, T3, T4, T5, R> {
    ...
    default F1<T2, F1<T3, F1<T4, F1<T5, R>>>> apply(final T1 s) {
        return Curry.curry5(this)
                    .apply(s);
    }

    default F1<T3, F1<T4, F1<T5, R>>> apply(final T1 s, final T2 s2) {
        return Curry.curry5(this)
                    .apply(s)
                    .apply(s2);
    }

    default F1<T4, F1<T5, R>> apply(final T1 s, final T2 s2, final T3 s3) {
        return Curry.curry5(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3);
    ...
    default F1<T5, R> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4) {
        return Curry.curry5(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3)
    ...
    default <V> F5<T1, T2, T3, T4,T5, V> andThen(Function<? super R, ? extends V> after) {
        return (t1,t2,t3,t4,t5)-> after.apply(apply(t1,t2,t3,t4,t5));
    }
    default F1<? super T1, F1<? super T2, F1<? super T3, F1<? super T4, F1<? super T5, ? extends R>>>>> curry() {
