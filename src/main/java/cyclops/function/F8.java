...
public interface F8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
    ...
    default F1<T2, F1<T3, F1<T4, F1<T5, F1<T6, F1<T7, F1<T8, R>>>>>>> apply(final T1 s) {
        return Curry.curry8(this)
                    .apply(s);
    }

    default F1<T3, F1<T4, F1<T5, F1<T6, F1<T7, F1<T8, R>>>>>> apply(final T1 s, final T2 s2) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2);
    }

    default F1<T4, F1<T5, F1<T6, F1<T7, F1<T8, R>>>>> apply(final T1 s, final T2 s2, final T3 s3) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3);
    ...
    default F1<T5, F1<T6, F1<T7, F1<T8, R>>>> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3)
    ...
    default F1<T6, F1<T7, F1<T8, R>>> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4, final T5 s5) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3)
    ...
    default F1<T7, F1<T8, R>> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4, final T5 s5, final T6 s6) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3)
    ...
    default F1<T8, R> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4, final T5 s5, final T6 s6, final T7 s7) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2)
                    .apply(s3)
    ...
    default F1<? super T1, F1<? super T2, F1<? super T3, F1<? super T4, F1<? super T5,F1<? super T6,F1<? super T7,F1<? super T8, ? extends R>>>>>>>> curry() {
