...
public interface F6<T1, T2, T3, T4, T5, T6, R> {
    ...
    default F1<T2, F1<T3, F1<T4, F1<T5, F1<T6, R>>>>> apply(final T1 s) {
        return Curry.curry6(this)
                    .apply(s);
    }

    default F1<T3, F1<T4, F1<T5, F1<T6, R>>>> apply(final T1 s, final T2 s2) {
        return apply(s).apply(s2);
    }

    default F1<T4, F1<T5, F1<T6, R>>> apply(final T1 s, final T2 s2, final T3 s3) {
        return apply(s).apply(s2)
                       .apply(s3);
    }

    default F1<T5, F1<T6, R>> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4) {
        return apply(s).apply(s2)
                       .apply(s3)
                       .apply(s4);
    }

    default F1<T6, R> apply(final T1 s, final T2 s2, final T3 s3, final T4 s4, final T5 s5) {
        return apply(s).apply(s2)
                       .apply(s3)
                       .apply(s4)
                       .apply(s5);
    ...
    default F1<? super T1, F1<? super T2, F1<? super T3, F1<? super T4, F1<? super T5,F1<? super T6, ? extends R>>>>>> curry() {
        return CurryVariance.curry6(this);
    }

    default <V> F6<T1, T2, T3, T4, T5, T6,V> andThen(Function<? super R, ? extends V> after) {
