...
public interface PersistentQueueX<T> extends To<PersistentQueueX<T>>,
     ...
     */
    public static <C2,T> Higher<C2, Higher<Mu,T>> widen2(Higher<C2, PersistentQueueX<T>> list){
     ...
     * @return PQueueType
     */
    public static <T> PersistentQueueX<T> narrowK(final Higher<Mu, T> list) {
  ...
  //  @Override
   ...
   // @Override
    ...
    public static class Instances {
         ...
         */
        public static <T> MonadPlus<Mu> monadPlus(Monoid<PersistentQueueX<T>> m){
            Monoid<Higher<Mu,T>> m2= (Monoid)m;
            return General.monadPlus(monadZero(),m2);
        }
        ...
        public static <T> Foldable<Mu> foldable(){
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldRightFn =  (m, l)-> PersistentQueueX.narrowK(l).foldRight(m);
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldLeftFn = (m, l)-> PersistentQueueX.narrowK(l).reduce(m);
