...
public interface HList<T1 extends HList<T1>> extends Sealed1Or<HList<T1>> {
   ...
   <TB> HCons<TB, T1> prepend(TB value);
    ...
    public static class HCons<T1, T2 extends HList<T2>> implements CaseClass2<T1,HList<T2>>, HList<HCons<T1,T2>> {
        ...
        @Override
        public <R> R match(Function<? super HList<HCons<T1, T2>>, ? extends R> fn1, Supplier<? extends R> s) {
    ...
    public static  class HNil implements HList<HNil> {
        ...
        @Override
        public <R> R match(Function<? super HList<HNil>, ? extends R> fn1, Supplier<? extends R> s) {
            return s.get();
        }
