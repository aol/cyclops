...
public interface DequeX<T> extends To<DequeX<T>>,
    ...
    /**
     * Generate a DequeX from the provided Supplier up toNested the provided limit number of times
     * 
     * @param limit Max number of elements toNested generate
     * @param s Supplier toNested generate DequeX elements
     * @return DequeX generated from the provided Supplier
     */
    ...
    /**
     * Create a DequeX by iterative application of a function toNested an initial element up toNested the supplied limit number of times
     * 
     * @param limit Max number of elements toNested generate
     ...
     * 
     * @param it Iterator toNested populate Deque
     ...
     * 
     * @param publisher
     *            toNested construct DequeX from
     * @return DequeX
     */
     ...
     * @param it Iterable toNested construct DequeX
     * @return DequeX
     */
     ...
     * </pre>
     * 
     * @param setX toNested narrow generic type
