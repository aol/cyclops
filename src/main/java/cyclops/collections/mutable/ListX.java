...
public interface ListX<T> extends To<ListX<T>>,
     ...
     * @return ListX
     */
    public static <T> ListX<T> narrowK(final Higher<Mu, T> list) {
        return (ListX<T>)list;
    }
    static class Instances {
         ...
         */
        public static <T> MonadPlus<Mu> monadPlus(Monoid<ListX<T>> m){
            Monoid<Higher<Mu,T>> m2= (Monoid)m;
            return General.monadPlus(monadZero(),m2);
        }
        ...
        public static <T> Foldable<Mu> foldable(){
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldRightFn =  (m, l)-> ListX.fromIterable(narrow(l)).foldRight(m);
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldLeftFn = (m, l)-> ListX.fromIterable(narrow(l)).reduce(m);
         ...
         */
        public static <C2, T> Higher<C2, Higher<Mu, T>> widen2(Higher<C2, ListX<T>> flux) {
         ...
         * @return ListType
         */
        public static <T> ListX<T> narrowK(final Higher<Mu, T> future) {
         ...
         */
        public static <T> ListX<T> narrow(final Higher<Mu, T> completableList) {
