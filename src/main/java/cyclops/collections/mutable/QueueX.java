...
public interface QueueX<T> extends To<QueueX<T>>,Queue<T>,
    ...
    */
     ...
     * @param s Supplier toNested generate QueueX elements
     ...
     * 
     * @param it Iterator toNested populate QueueX
     ...
     * 
     * @param publisher
     *            toNested construct QueueX from
     * @return QueueX
     */
    ...
    public static class Instances {
         ...
         * </pre>
         *
         * @param m Monoid toNested use for combining Queues
