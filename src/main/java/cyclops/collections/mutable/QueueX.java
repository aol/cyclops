...
public interface QueueX<T> extends To<QueueX<T>>,Queue<T>,
     ...
     */
    public static <C2,T> Higher<C2, Higher<Mu,T>> widen2(Higher<C2, QueueX<T>> queue){
     ...
     * @return QueueType
     */
    public static <T> QueueX<T> narrowK(final Higher<Mu, T> queue) {
    ...
    */
    ...
    public static class Instances {
         ...
         */
        public static <T> MonadPlus<Mu> monadPlus(Monoid<QueueX<T>> m){
            Monoid<Higher<Mu,T>> m2= (Monoid)m;
            return General.monadPlus(monadZero(),m2);
        }
        ...
        public static <T> Foldable<Mu> foldable(){
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldRightFn =  (m, l)-> QueueX.narrowK(l).foldRight(m);
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldLeftFn = (m, l)-> QueueX.narrowK(l).reduce(m);
