...
import cyclops.control.anym.Witness.ior;
...
import cyclops.control.anym.Witness.streamable;
...
public interface AnyM<W extends WitnessType<W>,T> extends   Unwrapable,
     ...
     * If this AnyM can only store a single value an Xor.lazyLeft with type AnyMValue is returned
