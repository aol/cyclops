...
public class ReaderWriterState<R,W,S,T>  {
    ...
    private final BiFunction<R,S, Free<Fn0.SupplierKind.Mu,Tuple3<W, S, T>>> runState;
    ...
    public  ReaderWriterState<R,W,S,T> tell(W value) {
        BiFunction<? super R, ? super S, Free<Fn0.SupplierKind.Mu,Tuple3<W,S, T>>> fn =
    ...
    public ReaderWriterState<R,W,S,T> local(Function<? super  R,? extends R> fn) {
        BiFunction<? super R, ? super S, Free<Fn0.SupplierKind.Mu,Tuple3<W,S, T>>> runFn = (R r, S s) -> runState.apply(fn.apply(r), s);
    ...
    private static <R,W,S,T> ReaderWriterState<R,W,S,T> suspended(BiFunction<? super R, ? super S, Free<Fn0.SupplierKind.Mu,Tuple3<W,S, T>>> runF,
                                                                  Monoid<W> monoid) {
