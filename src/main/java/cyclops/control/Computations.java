...
public abstract class Computations<T> {
     ...
     */
    public static <T1, T2, T3, R1, R2, R3, R> Computations<R> forEach4(Computations<? extends T1> value1,
                                                                       Function<? super T1, ? extends Computations<R1>> value2,
                                                                       BiFunction<? super T1, ? super R1, ? extends Computations<R2>> value3,
                                                                       Fn3<? super T1, ? super R1, ? super R2, ? extends Computations<R3>> value4,
     ...
     * @return Computations with a combined value generated by the yielding function
     */
    public static <T1, T2, R1, R2, R> Computations<R> forEach3(Computations<? extends T1> value1,
                                                               Function<? super T1, ? extends Computations<R1>> value2,
                                                               BiFunction<? super T1, ? super R1, ? extends Computations<R2>> value3,
     ...
     * @return Computations with a combined value generated by the yielding function
     */
    public static <T, R1, R> Computations<R> forEach2(Computations<? extends T> value1, Function<? super T, Computations<R1>> value2,
