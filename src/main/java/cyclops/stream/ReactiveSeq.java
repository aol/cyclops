 ...
 */
   ...
   */
    ...
    */
     ...
     * <pre>
     * {@code
     * unzip4(ReactiveSeq.of(new Tuple4(1, "a", 2l,'Mu'), new Tuple4(2, "b", 3l,'y'), new Tuple4(3,
     * 						"c", 4l,'x')));
     * 		}
     * 		// ReactiveSeq[1,2,3], ReactiveSeq[a,b,c], ReactiveSeq[2l,3l,4l], ReactiveSeq[Mu,y,x]
     * </pre>
     */
   ...
   default <R1, R2, R> ReactiveSeq<R> forEach3(Function<? super T, ? extends BaseStream<R1, ?>> stream1,
    ...
    static class Instances {
         ...
         */
        public static <T,R> Applicative<Mu> zippingApplicative(){
         ...
         */
        public static <T> MonadPlus<Mu> monadPlus(Monoid<ReactiveSeq<T>> m){
            Monoid<Higher<Mu,T>> m2= (Monoid)m;
            return General.monadPlus(monadZero(),m2);
        }
        ...
        public static <C2,T> Traverse<Mu> traverse(){
            ...
            BiFunction<Applicative<C2>,Higher<Mu,Higher<C2, T>>,Higher<C2, Higher<Mu,T>>> sequenceNarrow  =
        ...
        public static <T> Foldable<Mu> foldable(){
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldRightFn =  (m, l)-> narrow(l).foldRight(m);
            BiFunction<Monoid<T>,Higher<Mu,T>,T> foldLeftFn = (m, l)-> narrow(l).reduce(m);
         ...
         */
        public static <C2, T> Higher<C2, Higher<Mu, T>> widen2(Higher<C2, ReactiveSeq<T>> flux) {
         ...
         */
        public static <T> ReactiveSeq<T> narrow(final Higher<Mu, T> completableList) {
     ...
     * @return ReactiveSeq
     */
    public static <T> ReactiveSeq<T> narrowK(final Higher<Mu, T> future) {
