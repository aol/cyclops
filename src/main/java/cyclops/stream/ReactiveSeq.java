 ...
 */
   ...
   */
   ...
   default ReactiveSeq<T> shuffle(final Random random) {
     ...
     * {@code
     * ReactiveSeq.of(1,2,3,4,5,6)
     *              .groupedBySizeAndTime(3,10,TimeUnit.SECONDS,()->SetX.zero())
     *              .toList();
     *
     * //[[1,2,3],[4,5,6]]
     * }
    ...
    */
     ...
     * <pre>
     * {@code
     *  ReactiveSeq.unfold(1,i->i<=6 ? Optional.of(Tuple.tuple(i,i+1)) : Optional.zero());
     *
     * //(1,2,3,4,5)
     *
     * }</code>
    ...
    /**
     * If this ReactiveSeq is zero one it with a another Stream
     *
     * <pre>
     * {@code
