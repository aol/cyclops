...
public class KleisliK<W,T,R> implements Fn1<T,Higher<W,R>>,
    ...
    public <R1, R2, R3, R4> KleisliK<W,T,R4> forEach4(Function<? super R, Function<? super T,? extends Higher<W,? extends R1>>> value2,
        ...
        return this.flatMapK(in -> {
            ...
            KleisliK<W,T,R1> a = kleisliK(monad,value2.apply(in));
            return a.flatMapK(ina -> {
                KleisliK<W,T,R2> b = kleisliK(monad,value3.apply(in,ina));
                return b.flatMapK(inb -> {

                    KleisliK<W,T,R3> c = kleisliK(monad,value4.apply(in,ina,inb));
    ...
    public static <T,R,W> KleisliK<W,T,R> kleisliK(Monad<W> monad, Function<? super T,? extends Higher<W,? extends R>> fn){
        return of(monad,fn);
    }
