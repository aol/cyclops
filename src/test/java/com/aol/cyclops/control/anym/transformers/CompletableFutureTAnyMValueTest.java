...
public class CompletableFutureTAnyMValueTest extends BaseAnyMValueTest {
    @Before
    public void setUp() throws Exception {
        just = AnyM.fromCompletableFutureTValue(CompletableFutureT.fromOptional(Optional.of(CompletableFuture.completedFuture(10))));
        
        none = AnyM.fromCompletableFutureTValue(CompletableFutureT.emptyMaybe());
    }
    @Test
