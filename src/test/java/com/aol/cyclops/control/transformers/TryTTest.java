...
public class TryTTest implements Printable {

	TryTValue<Integer> just;
	TryTValue<Integer> none;
	@Before
	...
	public void testMkString() {
		assertThat(just.mkString(),equalTo("TryTValue[10]"));
		assertThat(none.mkString(),equalTo("TryTValue[]"));
	}
