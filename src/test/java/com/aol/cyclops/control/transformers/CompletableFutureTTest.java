...
public class CompletableFutureTTest implements Printable {
	...
	CompletableFutureTValue<Integer> just;
	CompletableFutureTValue<Integer> none;
	@Before
	public void setUp() throws Exception {
		just = CompletableFutureTValue.of(CompletableFuture.completedFuture(10));
		none = CompletableFutureT.emptyMaybe();
	}
	...
	public void testMkString() {
		assertThat(just.mkString(),equalTo("CompletableFutureTValue[10]"));
		assertThat(none.mkString(),equalTo("CompletableFutureTValue[]"));
	}
