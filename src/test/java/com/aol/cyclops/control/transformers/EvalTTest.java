...
public class EvalTTest implements Printable {
	...
	public void testUnitT() {
		assertThat(just.unit(20).value(),equalTo(Eval.now(20)));
	}
	...
	public void testFlatMap() {
		...
		assertThat(just.flatMap(i->Eval.now(i+5)).value(),equalTo(Eval.now(15)));
		assertThat(none.flatMap(i->Eval.now(i+5)).isValuePresent(),equalTo(false));
	}
	...
	public void testMkString() {
		assertThat(just.mkString(),equalTo("EvalTValue[10]"));
		assertThat(none.mkString(),equalTo("EvalTValue[]"));
	}
	...
	public void testMapFunctionOfQsuperTQextendsR1() {
		assertThat(just.map(i->i+5).value(),equalTo(Eval.now(15)));
	}
	...
	public void testTrampoline() {
		assertThat(just.trampoline(n ->sum(10,n)).value(),equalTo(Eval.now(65)));
	}
