...
public class SlidingOperatorTest extends AbstractOperatorTest {
    ...
    public Operator<Integer> createEmpty(){
        return new MapOperator<List<Integer>,Integer>(new SlidingOperator(new ArrayOfValuesOperator<>(),
                i->i,1,1),i->i.get(0));
    }
    public Operator<Integer> createOne(){
        return new MapOperator<List<Integer>,Integer>(new SlidingOperator(new ArrayOfValuesOperator<>(1),
                i->i,1,1),i->i.get(0));
    ...
    public Operator<Integer> createThree(){
        ...
        return new MapOperator<List<Integer>,Integer>(new SlidingOperator(new IterableSourceOperator(list),
                i->i,3,3),i->i.get(0));
    }
