...
public class StatCollectorsTest {
    ...
    public void doubleCollect(){
        ...
        assertThat(t2.v1(),equalTo(stream.toList()));
        assertThat(t2.v2(),equalTo(stream.toSet()));
    }
    @Test
    public void tripleCollect(){
        ...
        assertThat(t3.v1(),equalTo(stream.toList()));
        assertThat(t3.v2(),equalTo(stream.toSet()));
        assertThat(t3.v3(),equalTo(stream.toList()));
    }
