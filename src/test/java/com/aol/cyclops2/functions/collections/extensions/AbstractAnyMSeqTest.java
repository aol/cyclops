	...
	public void presentConvert(){
        ...
        public void testShuffleRandom() {
            ...
            public void groupedFunctionCollectorNoOrder(){
                assertThat(of(1,2,3).grouped(f-> f<3? "a" : "b", Collectors.toListX()).count(),equalTo((2L)));
                assertThat(of(1,2,3).grouped(f-> f<3? "a" : "b", Collectors.toListX()).filter(t->t.v1.equals("a"))
                        .map(t->t.v2).single(),
