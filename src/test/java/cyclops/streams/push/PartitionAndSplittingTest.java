...
public class PartitionAndSplittingTest {
	...
	public void testSplitAtHead() {
		...
		assertEquals(asList(), Spouts.of(1).splitAtHead().v2.toList());

		assertEquals(Optional.empty(), of().splitAtHead().v1);
		assertEquals(asList(), Spouts.of().splitAtHead().v2.toList());

		assertEquals(Optional.of(1), Spouts.of(1).splitAtHead().v1);

		assertEquals(Optional.of(1), Spouts.of(1, 2).splitAtHead().v1);
		assertEquals(asList(2), Spouts.of(1, 2).splitAtHead().v2.toList());

		assertEquals(Optional.of(1), Spouts.of(1, 2, 3).splitAtHead().v1);
		assertEquals(Optional.of(2), Spouts.of(1, 2, 3).splitAtHead().v2.splitAtHead().v1);
		assertEquals(Optional.of(3), Spouts.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.splitAtHead().v1);
		assertEquals(asList(2, 3), Spouts.of(1, 2, 3).splitAtHead().v2.toList());
		assertEquals(asList(3), Spouts.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.toList());
		assertEquals(asList(), Spouts.of(1, 2, 3).splitAtHead().v2.splitAtHead().v2.splitAtHead().v2.toList());
	}
