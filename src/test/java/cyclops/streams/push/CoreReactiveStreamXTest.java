...
public  class CoreReactiveStreamXTest {
	...
	public void shuffle(){
		...
		assertEquals(3, Spouts.of(1, 2, 3).shuffle().toListX().size());
	}
	@Test
	public void shuffleRandom(){
		Random r = new Random();
		assertEquals(3, Spouts.of(1, 2, 3).shuffle(r).toListX().size());
	}
	...
	public void prependStreams(){
		...
		public void flatten() throws Exception {
			assertThat(Spouts.of(Arrays.asList(1,2)).to(ReactiveSeq::flattenI).toList().size(),equalTo(asList(1,  2).size()));
		}
