...
public class Tuple6Test {
    ...
    public void setUp() throws Exception {
        tuple = Tuple.tuple(2,5,10,10,10,10);
        called=  0;
    ...
    public void of() throws Exception {
        assertThat(Tuple6.of(2,5,10,10,10,10),equalTo(tuple));
    }

    int called;
    @Test
    public void lazy() throws Exception {
        Tuple6<String,Integer,Integer,Integer,Integer,Integer> lazyT1 = Tuple.lazy(()->{
            called++;
            return "hello";
        },()->1,()->2,()->3,()->4,()->8);
    ...
    public void map() throws Exception {
        assertThat(tuple.mapAll(i->i+1, i->i+1,i->i+1,i->i+1,i->i+1,i->i+1),
                equalTo(Tuple.tuple(3,6,11,11,11,11)));
    }
    ...
    public void eager() throws Exception {
        assertThat(Tuple.lazy(()->"z1",()->"x1",()->"w1",()->"new",()->"boo!",()->"hello").eager(),
                equalTo(Tuple.tuple("z1","x1","w1","new","boo!","hello")));
    }
    ...
    public void lazyMap() throws Exception {
        assertThat(tuple.lazyMapAll(i->i+1, i->i+1,i->i+1,i->i+1,i->i+1,i->i+1),
                equalTo(Tuple.tuple(3,6,11,11,11,11)));
        tuple.lazyMapAll(i->{
            called++;
            return i+1;
    ...
    public void testToString() throws Exception {
        assertThat(tuple.toString(),equalTo("[2,5,10,10,10,10]"));
    }
