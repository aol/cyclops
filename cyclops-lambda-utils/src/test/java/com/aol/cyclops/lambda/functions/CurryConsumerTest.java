...
import com.aol.cyclops.comprehensions.functions.CurryConsumer;
...
public class CurryConsumerTest {
	...
	public void testCurry2() {
		CurryConsumer.curry2( (Integer a, Integer b) -> value = a+b).apply(2).accept(3);
		assertThat(value,equalTo(5));
	}

	@Test
	public void testCurry3() {
		CurryConsumer.curry3( (Integer a, Integer b, Integer c) -> value = a+b+c).apply(2).apply(2).accept(3);
	...
	public void testCurry5() {
		CurryConsumer.curry5( (Integer a, Integer b, Integer c,Integer d, Integer e) -> value = a+b+c+d+e).apply(2).apply(1).apply(10).apply(2).accept(3);
