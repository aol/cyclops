...
public class TupleMethodChainingAsyncTest {
	...
	public void testConvertT4(){
		...
		assertThat(Tuple4.of(1,2,3,4).applyAsync4(curry4(this::method4params)).join(),equalTo(10));
		
	}
	@Test
	public void testConvertT5(){
		
		assertThat(Tuples.tuple(1,2,3,4,5).applyAsync5(curry5(this::method5params)).join(),equalTo(15));
		
	}
	@Test
	public void testConvertT6(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6).applyAsync6(curry6(this::method6params)).join(),equalTo(21));
		
	}
	@Test
	public void testConvertT7(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6,7).applyAsync7(curry7(this::method7params)).join(),equalTo(28));
		
	}
	@Test
	public void testConvertT8(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6,7,8).applyAsync8(curry8(this::method8params)).join(),equalTo(36));
