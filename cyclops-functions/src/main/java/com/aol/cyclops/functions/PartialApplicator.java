...
public class PartialApplicator extends Lambda {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> BiFunction<T7, T8, R> partial8(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> TriFunction<T6, T7, T8, R> partial8(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> QuadFunction<T5, T6, T7, T8, R> partial8(T1 t1, T2 t2, T3 t3, T4 t4, OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> QuintFunction<T4, T5, T6, T7, T8, R> partial8(T1 t1, T2 t2, T3 t3, OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> HeptFunction<T2, T3, T4, T5, T6, T7, T8, R> partial8(T1 t1, OctFunction<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
