...
public interface PVectorX<T> extends PVector<T>, PersistentCollectionX<T>{
	...
	default <R> PVectorX<R> patternMatch(R defaultValue,
		...
		return (PVectorX<R>)PersistentCollectionX.super.patternMatch(defaultValue, case1, case2);
	}
	/* (non-Javadoc)
	...
	default <R> PVectorX<R> patternMatch(R defaultValue,
		...
		return (PVectorX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3);
	}
	/* (non-Javadoc)
	...
	default <R> PVectorX<R> patternMatch(R defaultValue,
		...
		return (PVectorX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3, fn4);
	}
	/* (non-Javadoc)
	...
	default <R> PVectorX<R> patternMatch(R defaultValue,
		...
		return (PVectorX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3, fn4, fn5);
	}
