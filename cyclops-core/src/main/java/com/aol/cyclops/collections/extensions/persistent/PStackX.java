...
public interface PStackX<T> extends PStack<T>, PersistentCollectionX<T>, FluentSequenceX<T>{
	...
	default <R> PStackX<R> patternMatch(R defaultValue,
		...
		return (PStackX<R>)PersistentCollectionX.super.patternMatch(defaultValue, case1, case2);
	}
	/* (non-Javadoc)
	...
	default <R> PStackX<R> patternMatch(R defaultValue,
		...
		return (PStackX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3);
	}
	/* (non-Javadoc)
	...
	default <R> PStackX<R> patternMatch(R defaultValue,
		...
		return (PStackX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3, fn4);
	}
	/* (non-Javadoc)
	...
	default <R> PStackX<R> patternMatch(R defaultValue,
		...
		return (PStackX<R>)PersistentCollectionX.super.patternMatch(defaultValue, fn1, fn2, fn3, fn4, fn5);
	}
