...
public class Optionals {
	...
	public static <T,R> Optional<R> accumulateJust(CollectionX<Optional<T>> maybes,Reducer<R> reducer){
		return sequence(maybes).map(s->s.mapReduce(reducer));
	}
	public static <T,R> Optional<R> accumulateJust(CollectionX<Optional<T>> maybes,Function<? super T, R> mapper,Semigroup<R> reducer){
