...
public class ApplyingZippingApplicativeBuilder<T,R, A extends ZippingApplicativable<R> >  {
		...
		public <T2,T3,T4> ZippingApplicative3<T2,T3,T4,R,A> applicative4(QuadFunction<? super T,? super T2,? super T3,? super T4,? extends R> fn){
		...
		public <T2,T3,T4,T5>  ZippingApplicative4<T2,T3,T4,T5,R,A>  applicative5(QuintFunction<? super T,? super T2,? super T3,? super T4,? super T5,? extends R> fn){
