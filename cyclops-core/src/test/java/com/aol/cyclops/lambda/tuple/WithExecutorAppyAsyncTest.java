...
public class WithExecutorAppyAsyncTest {
	Executor exec = ForkJoinPool.commonPool();
	@Test
	public void testConvertT1(){
		
		assertThat(methodTuple1().callAsync(this::method3,exec).join(),equalTo("10"));
		
	}
	@Test
	public void testConvertT2(){
		
		assertThat(methodTuple2().callAsync(this::method2,exec).join(),equalTo("10hello"));
		
	}
	@Test
	public void testConvertT3(){
		
		assertThat(methodTuple3().callAsync(this::method3params,exec).join(),equalTo("10hello3"));
		
	}
	@Test
	public void testConvertT4(){
		
		assertThat(PTuple4.of(1,2,3,4).callAsync(this::method4params,exec).join(),equalTo(10));
		
	}
	@Test
	public void testConvertT5(){
		
		assertThat(PowerTuples.tuple(1,2,3,4,5).callAsync(this::method5params,exec).join(),equalTo(15));
		
	}
	@Test
	public void testConvertT6(){
		
		assertThat(PowerTuples.tuple(1,2,3,4,5,6).callAsync(this::method6params,exec).join(),equalTo(21));
		
	}
	@Test
	public void testConvertT7(){
		
		assertThat(PowerTuples.tuple(1,2,3,4,5,6,7).callAsync(this::method7params,exec).join(),equalTo(28));
		
	}
	@Test
	public void testConvertT8(){
		
		assertThat(PowerTuples.tuple(1,2,3,4,5,6,7,8).callAsync(this::method8params,exec).join(),equalTo(36));
