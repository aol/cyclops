...
[source,java]
----
ReactiveSeq.of(1, 2, 3, 4, 5,1).dropWhile(i->i<5);
...
[source,java]
----
ReactiveSeq.of(1, 2, 3, 4, 5,6).takeWhile(i->i<5);
...
[source,java]
----
ReactiveSeq.of(1, 2, 3, 4, 5).dropWhile(i->i==4);
...
[source,java]
----
ReactiveSeq.of(1, 2, 3, 4, 5).takeWhile(i->i==4);
