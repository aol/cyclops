...
cyclops-react provides suspended package (com.aol.cyclops-react.collections) filled with companion classes for creating instances of PCollections. Each companion class offers handy methods for collection creation and conversion (reduction) from suspended Stream.
