 ...
 */
public class LazyMap8PTuple8<T,T1,T2,T3,T4,T5,T6,T7,T8> extends TupleImpl<T1,T2,T3,T4,T5,T6,T,T8> {
    ...
    public LazyMap8PTuple8( Function<T7, T> fn,PTuple8<T1,T2,T3,T4,T5,T6,T7,T8> host){
        super(host.arity());
        this.host = host;
        this.fn = fn;
    }
    public T v7(){
        return value.getOrSet(()->fn.apply(host.v7()));
    }
