...
public class WithExecutorAppyAsyncTest {
	...
	public void testConvertT4(){
		...
		assertThat(Tuple4.of(1,2,3,4).callAsync(this::method4params,exec).join(),equalTo(10));
		
	}
	@Test
	public void testConvertT5(){
		
		assertThat(Tuples.tuple(1,2,3,4,5).callAsync(this::method5params,exec).join(),equalTo(15));
		
	}
	@Test
	public void testConvertT6(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6).callAsync(this::method6params,exec).join(),equalTo(21));
		
	}
	@Test
	public void testConvertT7(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6,7).callAsync(this::method7params,exec).join(),equalTo(28));
		
	}
	@Test
	public void testConvertT8(){
		
		assertThat(Tuples.tuple(1,2,3,4,5,6,7,8).callAsync(this::method8params,exec).join(),equalTo(36));
